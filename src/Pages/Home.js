  ...
  return (
      <div>
        <div className='flex flex-col items-center justify-center gap-7 h-[759px] bg-[#FFF6CC]' style={{ borderRadius: '0 0 50% 50% / 0 0 100% 100%' }}>
          <h1 className='font-Noto font-medium text-[25px] sm:text-[40px] leading-[35px] sm:leading-[60px]  h-[105px] w-[270px] sm:h-[120px] sm:w-[608px] text-center text-[#151B4A]'>We Empower Mom's Beliefs & Enable Childs's Growth.</h1>
